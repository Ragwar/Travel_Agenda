    ...
    public partial class emi : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Schedule_Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nr_Days = table.Column<int>(type: "int", nullable: true),
                    ...
                    Hotel_Id = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Residence_Lat = table.Column<double>(type: "float", nullable: true),
                    Residence_Lng = table.Column<double>(type: "float", nullable: true),
                    Residence_Address = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserInfo_Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserInfo", x => x.UserInfo_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Schedule_Activity_Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Start_Hour = table.Column<int>(type: "int", nullable: true),
                    End_Hour = table.Column<int>(type: "int", nullable: true),
                    Start_Minute = table.Column<int>(type: "int", nullable: true),
                    End_Minute = table.Column<int>(type: "int", nullable: true),
                    Start_Date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    End_Date = table.Column<DateTime>(type: "datetime2", nullable: true),
